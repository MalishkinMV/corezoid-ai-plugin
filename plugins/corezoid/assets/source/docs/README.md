...
- [Dashboards Overview](dashboards/README.md) - Creating dashboards, chart types, metrics binding, real-time mode

### API Gateway (APIGW)

- [API Gateway Overview](apigw/README.md) - Exposing processes as HTTP endpoints, authentication, sync/async modes

### MCP Server

- [MCP Server Overview](mcp/README.md) - Python MCP server setup, tool catalog (45 tools), configuration for Claude Code, Cursor, Windsurf

### API Reference

- [API Operations Map](api-ops-map.md) - Complete ops type mapping for all API objects (conv, node, task, folder, dashboard, chart, env_var, apigw, company)
